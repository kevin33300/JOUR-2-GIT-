...
$crepeauchocolat = new Crêpe (2,3,5,"nutella"); // ici on ne connait pas encore le topping donc on l'initialise en array puisque le topping constituera plusieurs éléments.
...
echo $crepeauchocolat-> getTopping();
